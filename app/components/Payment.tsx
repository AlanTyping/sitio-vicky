export default function Payment() {
  return (
    <section id="pago" className="bg-primary-50 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-lg rounded-3xl bg-white p-8 ring-1 ring-primary-200 sm:p-10 lg:mx-0 lg:max-w-none lg:flex lg:items-center">
          ...
          <div className="mt-10 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-primary-50 py-10 text-center ring-1 ring-inset ring-primary-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">

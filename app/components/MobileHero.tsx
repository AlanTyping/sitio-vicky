  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-sky-50 via-white to-white px-6 pb-14 pt-8 font-[family-name:var(--font-lexend)] lg:hidden">
      ...
      <div className="relative mx-auto max-w-xl">
        <p className="mb-5 text-xs font-bold uppercase tracking-[0.18em] text-sky-700 animate-fade-in-up">
          Habitar el aula · Bienestar docente
        </p>
        <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-sky-700 animate-fade-in-up opacity-0 [animation-fill-mode:forwards]">
          Soy Victoria Aphalo
        </h1>
        <p className="mt-5 text-2xl font-light leading-tight text-slate-700 animate-fade-in-up opacity-0 [animation-delay:200ms] [animation-fill-mode:forwards]">
          Acompaño a docentes a enseñar con más calma, claridad y presencia.
        </p>
        <p className="mt-5 max-w-md text-base leading-relaxed text-slate-600 animate-fade-in-up opacity-0 [animation-delay:400ms] [animation-fill-mode:forwards]">
          Un espacio de acompañamiento para docentes que quieren cuidar el vínculo, sin dejar de cuidarse a sí mismos.
        </p>

        <div className="mt-8 flex flex-col gap-3 sm:flex-row animate-fade-in-up opacity-0 [animation-delay:800ms] [animation-fill-mode:forwards]">
          <a
            href="#guia-gratuita"
